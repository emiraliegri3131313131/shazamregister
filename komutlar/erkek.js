...
const erkekrol = message.guild.roles.cache.find(r => r.id === '794609122762031129')
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '794609122762031128')
...
.setDescription(`<a:patlayankalp:798186022923927552> ${member}, Adlı Kullanıcı ${erkekrol} Olarak Kayıt Edildi , İsmi \`${tag} ${name} | ${age}\` Olarak Güncellendi.
